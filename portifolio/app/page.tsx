...
const Home: FC = () =>
{
  return(
    ...
    <div className="flex items-center justify-center min-h-screen bg-azul-claro rounded-lg">
      ...
      <p className="text-roxo-escuro text-lg mb-6">Sou uma desenvolvedora front-end focada em criar experiências digitais incríveis. Explore meus projetos e entre em contato!</p>
      </div>
    </div>
